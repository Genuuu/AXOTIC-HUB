...
const oldGridRegex = /<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">[\s\S]*?<\/div>\s*\{\/\* Division subteams dynamic integration \*\/\}/;

const newGrid = `<div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
